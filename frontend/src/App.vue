...
const navigationGroups = [
  {
    label: '分析模块',
    items: [
      ['/overview', '运营驾驶舱', 'M3 3h7v7H3V3Zm11 0h7v7h-7V3ZM3 14h7v7H3v-7Zm11 0h7v7h-7v-7Z'],
      ['/hospitals', '医院运营分析', 'M4 21V4h16v17M8 8h2m4 0h2M8 12h2m4 0h2M8 16h2m4 0h2M10 21v-4h4v4'],
      ['/diseases', '疾病画像分析', 'm4 4 6-2 10 4v14l-6 2-10-4V4Zm6-2v14m10-10-10 4m0 0L4 8'],
      ['/cohorts', '住院记录群体分析', 'M8 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm8-1a3 3 0 1 0 0-6m-12 11c0-3 2.7-5 6-5s6 2 6 5M16 13c2.5 0 4 1.4 4 4'],
      ['/costs', '费用与成本分析', 'M12 3v18M16 7.5C16 6.1 14.2 5 12 5S8 6.1 8 7.5 9.8 10 12 10s4 1.1 4 2.5-1.8 2.5-4 2.5-4-1.1-4-2.5'],
      ['/risks', '病情严重程度与风险分析', 'M12 3 21 7v5c0 5.1-3.4 8.3-9 9-5.6-.7-9-3.9-9-9V7l9-4Zm0 5v4m0 4h.01'],
      ['/payments', '支付方式分析', 'M3 6h18v12H3V6Zm0 4h18M7 15h4'],
      ['/data-quality', '数据质量管理', 'M5 3h14v18H5V3Zm3 4h8M8 11h8M8 15h5'],
    ],
  },
  {
    label: '辅助能力',
    items: [
      ['/model', '高费用记录分类', 'M4 5h16v14H4V5Zm4 4h8m-8 4h5m-5 4h3'],
      ['/assistant', 'AI 问答与洞察报告', 'M4 5h16v12H8l-4 4V5Zm4 5h.01M12 10h.01M16 10h.01'],
    ],
  },
]
